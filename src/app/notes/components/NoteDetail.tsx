...
export default function NoteDetail({ note }: NoteDetailProps) {
    ...
    // Save changes to store whenever content changes
    useEffect(() => {
        const updatedNote = {
            ...note,
            title,
            ...
            <div className="px-4 pt-8 flex justify-between">
                ...
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className="p-2 text-gray-500 hover:text-purple-500 hover:bg-gray-100 rounded-full transition-colors cursor-pointer"
                        title="Change color"
                    >
                    ...
                    <button
                        ...
                        className="p-2 text-gray-500 hover:text-red-500 hover:bg-gray-100 rounded-full transition-colors cursor-pointer"
                        title="Delete note"
                    >
                    ...
                    <button
                        ...
                        className="p-2 text-gray-500 bg-[#fbaeaeac] hover:text-gray-700 hover:bg-[#fea1a1ac] rounded-full transition-colors cursor-pointer"
                        title="Deselect note and go to grid view"
                    >
                        <X className="h-5 w-5" />
                    </button>
                </div>
